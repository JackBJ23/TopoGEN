...
Original file is located at
    https://colab.research.google.com/drive/12igPF1GE7WGgk0vikLyGnzaw-4DrYV0b
"""
...
import pickle
# 10, 31, 22, 83, 44, 15, 65, 5505, 77077, 80134
for seed in [44, 102, 44055, 7077, 1203, 33045, 50690, 1111, 40302, 6593]:
  print("seed", seed)
  torch.manual_seed(seed)
  model0 = VAE(n_latent)
  ...
  for batch_idx, (data, _) in enumerate(train_loader):
      ...
      loss = loss_fctn5(recon_batch, data, mean, log_var, dgm, dgm2, 10., 10.)
      # loss_fctn2(recon_batch, data, mean, log_var, dgm, dgm2, 5., 5.)
      # loss_fctn3(recon_batch, data, mean, log_var, dgm, dgm2, 3.5, 3.5, 0.1)
      # loss_fctn4(recon_batch, data, mean, log_var, dgm, dgm2, 5., 5., 0.1)
      # loss_fctn5(recon_batch, data, mean, log_var, dgm, dgm2, 10., 10.)
      loss.backward()
      optimizer2.step()
...
d50 /= n
d75 /= n
print("Mean absolute difference of BCE at 25, 50, 75 iterations:", d25, d50, d75, "Relative difference:", d25/avg25*100, d50/avg50*100, d75/avg75*100)
